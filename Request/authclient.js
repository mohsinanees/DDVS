...
const authorPrivateKey = fs.readFileSync(
    `/home/${USER}/.sawtooth/keys/${USER}.priv`,
    "utf8"
);
const authorPubKey = fs.readFileSync(
    `/home/${USER}/.sawtooth/keys/${USER}.pub`,
    "utf8"
);
const issuerPrivateKey = fs.readFileSync(
    `/home/mohsin/Documents/issuer.priv`,
    "utf8"
);
const issuerPubKey = fs.readFileSync(
    `/home/mohsin/Documents/issuer.pub`,
    "utf8"
);
const studentPrivateKey = fs.readFileSync(
    `/home/mohsin/Documents/student.priv`,
    "utf8"
);
const studentPubKey = fs.readFileSync(
    `/home/mohsin/Documents/student.pub`,
    "utf8"
);
