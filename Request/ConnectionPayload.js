/*                                                                            *  
   --------------------------------------------------------------------------- 
   | This is the Transaction Structure Definition for The Connection Request |
   | that will be generated by the every participant of the newtwork to join | 
   | the Network except The Network Initializer i.e Authorizer.              | 
   ---------------------------------------------------------------------------  
*                                                                             */
"use strict";
