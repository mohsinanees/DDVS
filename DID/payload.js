...
class DIDPayload {
    constructor(sourceDid, sourceVerKey, destDid, destVerKey, nonce, signature, role) {
    ...
    static async fromBytes(payload) {
        ...
        if (res) {
            ...
            return new DIDPayload(res.sourceDid, res.sourceVerKey, res.destDid,
                res.destVerKey, res.nonce, res.signature, res.role)
        } else {
